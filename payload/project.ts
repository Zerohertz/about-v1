...
const project: IProject.Payload = {
  ...
  list: [
    ...
    },
    {
      ...
      endedAt: '2022-12',
      where: 'SiM Lab. (Smart intelligent Manufacturing system Laboratory)',
      descriptions: [{ content: '롤 정렬도 불량에 따른 사행량 예측 모델 개발' }],
    },
    {
    ...
    },
    {
      ...
      endedAt: '2022-11',
      where: 'SiM Lab. (Smart intelligent Manufacturing system Laboratory)',
      descriptions: [{ content: '소재 온도 분포 파악을 위한 열전도도 프로파일 개발' }],
    },
    {
    ...
    },
    {
      ...
      endedAt: '2022-05',
      where: 'SiM Lab. (Smart intelligent Manufacturing system Laboratory)',
      descriptions: [{ content: 'Vision data 기반 머서라이징 공정 모니터링 시스템 개발' }],
    },
    {
    ...
    },
    {
      ...
      descriptions: [{ content: 'Unreal Engine 기반 가상 현실 환경 구축' }],
    },
    {
