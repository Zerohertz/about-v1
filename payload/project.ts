    ...
    },
    {
      ...
      descriptions: [
        ...
        { content: '화상 환자의 환부 Segmentation 및 심각도 진단 모델 개발' },
        {
          ...
          postImage: 'https://github.com/Zerohertz/Zerohertz/assets/42334717/4639cd97-0363-4d66-8f84-a1ade9a80177',
        },
      ],
    },
    {
      ...
      descriptions: [
        ...
        { content: 'Blog posts', href: 'https://zerohertz.github.io/tags/home-server/index.html', postImage: 'https://github-production-user-asset-6210df.s3.amazonaws.com/42334717/260747675-647d4089-f58f-4a46-b580-ed2760f52623.png' },
      ],
    },
    {
      title: '분류 모자이크',
      ...
      where: 'BOAZ',
      descriptions: [
        { content: 'Team-BoonMoSa', weight: 'MEDIUM', href: 'https://github.com/Team-BoonMoSa', postImage:'https://user-images.githubusercontent.com/42334717/227575043-5c65230c-f283-46b0-a46c-0569ee20cd56.gif' },
        { content: 'YOLOv5 기반 logo detection 모델 개발' },
        { content: 'Amazon EC2 Inf1 기반 모델 배포 서버 구축', postImage: 'https://github-production-user-asset-6210df.s3.amazonaws.com/42334717/253738363-d1cbc5e5-e0a1-4763-adeb-6657568a6a85.png' }
      ],
    },
    {
      title: '',
      ...
      descriptions: [
        {
          content: '권취 롤(copper film) 내부 응력 분포를 고려한 Web handling 불량 개선 방안 연구, SK 넥실리스',
          weight: 'BOLD',
          descriptions: [
          ...
          weight: 'BOLD',
          descriptions: [
            { content: 'SiM Lab. (2021. 09 ~ 2023. 01)' },
          ]
        },
        {
        ...
        {
          content: '이차전지전극을 위한 멀티코터가 구비된 지능형 롤투롤 코팅시스템 개발, 산업통상자원부',
          weight: 'BOLD',
          descriptions: [
        ...
        {
          content: '대면적 고효율 기능성 필름 대량 생산을 위한 스마트 인쇄 전자 제조 기술 개발, 한국연구재단',
          weight: 'BOLD',
          descriptions: [
        ...
        {
          content: '웹 핸들링 기반 롤 배치 최적화 및 Tilting에 따른 사행/주름 분석, LG 에너지솔루션',
          weight: 'BOLD',
          descriptions: [
        ...
        {
          content: '자동차용 배터리 전극 소재 떨림 최소화를 위한 건조 시스템 해석 및 공기 부양 유닛 노즐 최적화, LG 에너지솔루션',
          weight: 'BOLD',
          descriptions: [
        ...
        {
          content: '실감형 실내 사이클링을 위한 2자유도 실내 사이클링 플랫폼 및 가상현실기반 고품질 사이클링 시뮬레이션기술 개발, 중소벤처기업진흥공단',
          weight: 'BOLD',
          descriptions: [
